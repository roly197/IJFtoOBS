...
|SB_TeamScoreW|Text (GDI+)| text| <<0-9>>|White|Text to display the team score when in team mode|
...
|SB_TeamScoreB|Text (GDI+)| text| <<0-9>>|Blue|Text to display the team score when in team mode|
